...
import com.b2.ankiety.web.QuestionController;
...
privileged aspect QuestionController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> QuestionController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Question question = Question.fromJsonToQuestion(json);
